...
DROP TABLE IF EXISTS "choice_results" CASCADE;
...
CREATE TABLE story_choices(
        ...
        CONSTRAINT fk__choice1_id FOREIGN KEY (choice1_id) REFERENCES choices(choice_id),
        CONSTRAINT fk__choice2_id FOREIGN KEY (choice2_id) REFERENCES choices(choice_id));
...
results_id serial,
        ...
        CONSTRAINT fk__choice_id FOREIGN KEY (choice_id) REFERENCES choices(choice_id),
        CONSTRAINT fk__ending_id FOREIGN KEY (ending_id) REFERENCES endings(ending_id));    
       
       
 INSERT INTO story_pieces (story_id, story1, story2, story3, story4, story5,story6, story7, story8, story9, story10, story11, story12, story13, story14) VALUES 
 (1,' Snuggled and sleeping soundly under your covers late one night, you awaken to the sound of whispers.','"Who''s there?" you question the darkness, 
 ...
 what to do.', 'none', 'none', 'none', 'none', 'none', 'none','none', 'none', 'none', 'none','none'),
 (2,' You close your eyes, and hold completely still. Your breath catches with each creak and groan that echoes through the walls.', 
 ...
 your return, you feel a soft tug on the tip of your toe.', 'There is no question about it now, someone is in your room.', 'none', 'none', 'none','none', 'none', 'none', 'none','none'),
 (3,'You throw back the covers and leap out of bed, making sure to land beyond the grasp of whatever might be lurking underneath.', 
 'Sprinting down the hall in complete darkness, your hands outstretched to prevent a collision with obstacles known and unknown, you round the corner to your parents'' room.', 
 'Throwing the door open it crashes into the wall behind, sending your sleeping parents stumbling 
 ...
 (4,' You stare at the ceiling, willing the courage necessary, then toss your covers aside and fall to the ground, peering beneath the bed.','Your cheek 
 ...
 opponent, will lead to certain capture without assistance from someone else...someone like you.','none','none','none','none'),
 (5,'You ponder the possibilities for a moment.' ,'An evil goblin, a pathetic looking elf, a family flag.', 'This sounds like drama you''re not interested in getting involved with. 
 You could get in trouble! You could get hurt! You could get killed!', 'You tell Felix, that, 
 ...
 (6,'You are caught off-guard by such a request, but find yourself oddly flattered at the same time.', 'Considering your options 
 ...
 you settle on two.', 'none','none'),
 (7,'Felix''s whimpers coupled with the raucous laughter of the goblin create enough noise to conceal the sounds of your next move.', 'You spring 
 ...
 avoiding each swipe it makes.', 'You realize now that trying to overpowera tremendous beast might not have been the wisest course of action.', 'In a fit of rage, the goblin continues 
 ...
 (8,'Looking around the space, you see stacks of twinkling jewels, glittery trinkets, and shiny coins. Obviously, this goblin has a taste for house elves and valuable goods. 
 ...
 (9,'You turn to Felix and motion for him to stay put. Ever so carefully, you begin creeping toward the sleeping beast.', 'Watching it with laser focus, you round the side of the heap.', 
 ...
 (10,'You stand with Felix in the shadows listening carefully for movement. Only the continued sounds of slumber can be heard.', 'Even from a distance, 
 ...
 and take a deep breath.', 'You hurl the goblet with all your might across the room. Quickly, you duck back into the darkness as the crash echoes throughout 
 ...
 (11,'Ever so quietly, you peel back the covers. Slowly, holding your breath, you lower your feet to the floor and stand, wincing 
 ...
 mysterious figure vanished.' ,'You''re curious about both, but can only pursue one mystery.', 'none'),
(12,'You press your ear to the door, listening for some clue as to what might be behind it. Hearing nothing, you ease the door open slowly.', 'Poking 
...
stone staircase. You look up the stony stairs and wonder what might reside at the top of them. Treasure? Danger? There''s only one way to find out.', 'Carefully, you climb 
...
of some sort.', 'You can''t make out everything, but you catch bits and pieces.', '"Suffering", "Pain", "Death to the kingdom."', 'None of those seem promising. You have to stop her!'),
(13,'Taking one last look at the glowing light beneath the door, you spin on your heels and race down the hallway after the mysterious figure.', 'They''ve got a head start, but 
...
sit at the table.', 'Sam passes you a piece of watermelon.', 'You take it, and as you sink your teeth into the crunchy sweetness, you''re satisfied with your choice.', 'none'),
(14,'Standing in the doorway, you watch the witch carefully looking for the perfect opportunity to foil her sinister plans. She continues to add ingredients to the bubbling 
...
(15,'While the witch is preoccupied with her spell, you glance around for a weapon of some sort. If you can push pause on her plans, you can determine how best to end this madness.', 'Your eyes fall 
...
off the rack, but her preoccupation with her concoction continues.', 'Turning, you begin to move quietly across the room.', 'Each step closer heightens the possibility of detection.', 'As you draw nearer, you are startled 
...
(16,' Stepping over the crumpled body of the witch, you race to the edge of the cauldron. Inside the pot, a black liquid swirls and simmers like an ominous cloud. It begins to rise and pour 
...
(17,'You have to stop this! You have to find help!', 'You turn and quietly rush back down the stairs, through the library, and into the hall.', 'Racing to your parents'' room, you throw the door open 
...
'Rushing to the cauldron, you peer inside to see a swirling black mist. It''s like staring into the center of a tornado. You find yourself momentarily mesmerized by the circling black cloud. It''s only when you feel the presence of 
...
INSERT INTO choices (choice_id, choice) VALUES 
 (1, 'Stay in bed'), (2, 'Get up to investigate'), ( 3, 'Jump up and check under the bed'), ( 4, 'Run out of the room to get help'), (5, 'Refuse to help Felix'), (6, 'Offer to help Felix'),
 (7, 'Attack the goblin'), (8,'Bargain with the goblin'), (9, 'Sneak in'), (10, 'Create a distraction'), (11, 'Open the door to investigate the room'), (12,'Follow the mysterious figure down the hall'),
 (13, 'Knock over the cauldron'), (14, 'Grab something heavy to knock the witch out'), (15, 'Look for a way to stop the spell'), (16,'Go and find help');
 
INSERT INTO story_choices (story_id, choice1_id, choice2_id) VALUES
(1,1,2), (2,3,4), (4,5,6), (5,7,8), (6,9,10), (11,11,12), (12,13,14), (15, 15, 16);

INSERT INTO choice_results (choice_id, story_next, ending_id) VALUES
(1,2,7), (2,11,7), (3,4,7), (4,3,1), (5,5,7), (6,6,7), (7,7,2), (8,8,3), (9,9,2), (10,10,3), (11,12,7), (12,13,4), (13,14,5), (14,15,7), (15,16,3), (16,17,6);